...
L2NkcC9yb290Y2Ffc3NsX3JzYTIwMjIyLmNybDANBgkqhkiG9w0BAQsF
...
export const RUSSIAN_TRUSTED_SUB_CA_2024 = `-----BEGIN CERTIFICATE-----
...
export const RUSSIAN_TRUSTED_CA_CERTS = [
  RUSSIAN_TRUSTED_ROOT_CA,
  RUSSIAN_TRUSTED_SUB_CA,
  RUSSIAN_TRUSTED_SUB_CA_2024,
];
