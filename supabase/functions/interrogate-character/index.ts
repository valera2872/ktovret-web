...
const topicKeywords: Record<Exclude<TopicId, 'unknown'>, string[]> = {
  ...
  access: ['t-17', 't17', 'пропуск', 'стойк', 'проход', 'карт', 'карта доступа', 'турникет'],
  presence: ['офис', 'вернул', 'возвращал', 'приехал обратно', 'приехали обратно', 'ночью', '18:30', '20:47', 'порт', 'ресторан', 'алиби', 'ужин', 'rk-pixel', 'соврал'],
  session: ['t.vlasov', 'тимур', 'сесси', 'demo-04', 'удален', 'удалил', 'release'],
  nordlight: ['nordlight', 'r-03', 'r03', 'clean build', 'обзорн', 'утечк', 'r.k.'],
  motive: ['мотив', 'зачем', 'почему', 'продал', 'продаж', 'сделк', 'инвестор', 'деньг', 'транш'],
  pavel: ['павел', 'действиях павла', 'orbit', 'nightsafe', 'депозит', 'исчез'],
};
