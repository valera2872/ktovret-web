...
Статус: draft; web `0.5.0`, APK/Flutter заморожен.
...
Текущий статус `0.5.0`: **validate SUCCESS + deploy-preview SUCCESS + live browser review SUCCESS**. Проверены кинематографическая обложка, единое ведущее действие, progressive opening, арт-слой, strict interrogation pilot, четыре gated-состояния и authored eval 45/45.
