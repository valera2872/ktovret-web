...
Статус: draft; web `0.5.1`, APK/Flutter заморожен.
...
Текущий статус `0.5.1`: **validate SUCCESS + deploy-preview SUCCESS + live browser review SUCCESS**. Проверены понятность завязки без IT-знаний, кинематографическая обложка, единое ведущее действие, progressive opening, арт-слой, strict interrogation pilot, четыре gated-состояния и authored eval 45/45.
