  ...
  collections: [
    {
      ...
      title: '10 бесплатных детективных дел «Кто врёт?»',
      ...
      minimumCases: 6,
      source: 'free',
      description: '10 коротких интерактивных детективных дел Mystery Logic, которые можно пройти бесплатно в браузере без регистрации.',
