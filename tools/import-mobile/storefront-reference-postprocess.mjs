...
function footer(root){return `<footer class="ref-footer ref-wrap"><span>© 2026 Mystery Logic</span><span><a href="${root}dela/">Архив дел</a><a href="${root}detektivnye-igry-dlya-dvoih/">Для двоих</a><a href="${root}tom-1/">Полный архив</a><a href="${root}offer/">Условия</a></span></footer>`;}
...
function accessStrip({button=true,root='../'}={}){return `<section class="ref-access-strip"><div class="ref-access-stat"><span class="ico">♧</span><strong>15 дел</strong><span>бесплатно</span></div><div class="ref-access-stat"><span class="ico">▣</span><strong>85 дел</strong><span>в полном архиве</span></div><div class="ref-access-stat"><span class="ico">₽</span><strong>199 ₽</strong><span>разовая покупка</span></div><div class="ref-access-buy">${button?`<button class="ref-btn ref-btn-primary" type="button" data-volume-buy disabled aria-label="Открыть полный архив">Открыть полный архив →</button><small data-volume-payment-note>85 дел · 199 ₽ · без подписки</small>`:`<a class="ref-btn ref-btn-primary" href="${root}tom-1/">Открыть полный архив →</a><small>85 дел · 199 ₽ · без подписки</small>`}</div></section>`;}
...
function archiveGrid(items,{premiumSamples=false,root='../'}={}){
  ...
  if(premiumSamples){
    ...
    cards=[...free.map((x,i)=>caseCard(x,i+1,'Бесплатно',false,root)),...paid.map((x,i)=>caseCard(x,i+3,'В полном архиве',true,root))];
