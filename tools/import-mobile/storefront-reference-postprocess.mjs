...
const wave=()=>Array.from({length:35},(_,i)=>`<i aria-hidden="true"></i>`).join('');
...
<section class="ref-manifesto" id="method"><div><h2>Честная детективная задача уважает игрока.</h2><p>Ключевая улика не возникает из воздуха, а решение не зависит от случайной догадки.<br>Все необходимые данные уже есть в материалах дела.</p></div><div class="ref-seal">ML</div></section>
</main>`;}
...
function caseCard(item,i,badge='Бесплатно',locked=false,root='../'){
  ...
  const category=esc(item?.category||'Логика');
