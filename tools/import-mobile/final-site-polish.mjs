...
const hubTitles=new Map([
  ...
  ['tom-1/index.html','Первый том «Кто врёт?» — 85 платных дел'],
...
const patchRussianInterface=(siteRoot)=>{
  const replacements=new Map([
    ['110 коротких дел: обстоятельства, показания, улики и один доказуемый ответ. Первые 10 дел доступны бесплатно.','Сто коротких дел: обстоятельства, показания, улики и один доказуемый ответ. Первые 15 дел доступны бесплатно.'],
    ['110 коротких дел: обстоятельства, показания, логические ограничения и единственный доказуемый ответ. 10 расследований доступны бесплатно.','Сто коротких дел: обстоятельства, показания, логические ограничения и единственный доказуемый ответ. 15 расследований доступны бесплатно.'],
