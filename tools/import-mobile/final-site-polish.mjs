...
const patchCaseTitles=(siteRoot)=>{
  ...
  if(patched!==110) throw new Error(`Final polish expected 110 case titles, got ${patched}`);
  if(branded!==0) throw new Error(`Final polish left ${branded} branded case titles`);
  return {patched,branded};
};

const hubTitles=new Map([
  ['kto-vret/index.html','«Кто врёт?» — 110 детективных дел онлайн'],
  ['dela/index.html','Архив «Кто врёт?» — 110 детективных дел'],
  ['tom-1/index.html','«Кто врёт?» — 100 платных дел в двух томах'],
  ['detektivnye-igry-onlayn/index.html','Детективные игры онлайн бесплатно — 10 дел'],
  ...
  ['ru/besplatnye-detektivnye-dela/index.html','10 бесплатных детективных дел онлайн'],
...
const patchRussianInterface=(siteRoot)=>{
  const replacements=new Map([
    ['Сто коротких дел: обстоятельства, показания, логические ограничения и единственный доказуемый ответ. 15 расследований доступны бесплатно.','110 коротких дел: обстоятельства, показания, улики и один доказуемый ответ. Первые 10 дел доступны бесплатно.'],
    ['Сто коротких дел: обстоятельства, показания, улики и один доказуемый ответ. Первые 15 дел доступны бесплатно.','110 коротких дел: обстоятельства, показания, улики и один доказуемый ответ. Первые 10 дел доступны бесплатно.'],
