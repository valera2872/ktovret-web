...
export function applyStorefrontV2Contracts(siteRoot){
  ...
  insertBeforeMainEnd(catalog,`<section class="sf-contract-note" data-storefront-v2-contract><p class="ml-kicker">Архивы первого тома</p><h2>Ещё 85 дел — одной покупкой</h2><p>Одна разовая покупка открывает продолжение архива без подписки и регулярных списаний.</p></section>`);
