...
const patchCaseSeo=(siteRoot)=>{
  ...
  for(const entry of fs.readdirSync(casesRoot,{withFileTypes:true})){
    ...
    const description=isFree
      ...
      : `«${caseName}» — ${shortDescriptor}. Сопоставьте факты, найдите противоречие. Полное дело доступно в платном томе «Кто врёт?».`;
...
const hubSeo=new Map([
  ['index.html',{title:'Детективные игры онлайн — 15 бесплатных дел',meta:'Mystery Logic — детективные игры онлайн, логические загадки и расследования. 15 дел доступны бесплатно в браузере без регистрации.'}],
  ['kto-vret/index.html',{title:'«Кто врёт?» — 100 детективных дел онлайн',meta:'«Кто врёт?» — 100 коротких детективных дел: первые 15 бесплатно, ещё 85 открываются одной покупкой за 199 ₽. Без подписки.'}],
  ['dela/index.html',{title:'Архив «Кто врёт?» — 100 детективных дел',meta:'Архив «Кто врёт?»: 15 бесплатных детективных дел онлайн и ещё 85 расследований в полном первом томе. Выбирайте по теме и сложности.'}],
  ['tom-1/index.html',{title:'Первый том «Кто врёт?» — 85 платных дел',meta:'Первый том «Кто врёт?» открывает ещё 85 детективных дел за 199 ₽. Разовая покупка, без подписки и повторных списаний.',h1:'Первый том «Кто врёт?» — ещё 85 детективных дел'}],
