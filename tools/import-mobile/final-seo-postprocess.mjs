...
const patchCaseSeo=(siteRoot)=>{
  ...
  for(const entry of fs.readdirSync(casesRoot,{withFileTypes:true})){
    ...
    const description=isFree
      ...
      : `«${caseName}» — ${shortDescriptor}. Сопоставьте факты, найдите противоречие. Полное дело доступно в платных томах «Кто врёт?».`;
  ...
  if(patched!==110) throw new Error(`Final SEO expected 110 case pages, got ${patched}`);
...
const hubSeo=new Map([
  ['index.html',{title:'Детективные игры онлайн — 10 бесплатных дел',meta:'Mystery Logic — детективные игры онлайн, логические загадки и головоломки. 10 дел доступны бесплатно в браузере без регистрации.'}],
  ['kto-vret/index.html',{title:'«Кто врёт?» — 110 детективных дел онлайн',meta:'«Кто врёт?» — 110 коротких детективных дел: 10 бесплатно и 100 платных в двух томах по 50. Найдите противоречие и докажите ответ.'}],
  ['dela/index.html',{title:'Архив «Кто врёт?» — 110 детективных дел',meta:'Архив «Кто врёт?»: 10 бесплатных детективных дел онлайн и 100 платных расследований в двух томах по 50. Выбирайте дело по теме и сложности.'}],
  ['tom-1/index.html',{title:'Тома «Кто врёт?» — 100 платных детективных дел',meta:'«Кто врёт?»: Том I — 50 дел за 199 ₽, Том II — 50 дел за 199 ₽, оба тома — 100 платных дел за 299 ₽. Разовая покупка, без подписки.',h1:'Тома «Кто врёт?» — 100 платных детективных дел'}],
  ['detektivnye-igry-onlayn/index.html',{title:'Детективные игры онлайн бесплатно — 10 дел',meta:'Детективные игры онлайн бесплатно: 10 коротких дел в браузере без регистрации. Изучайте показания, находите противоречия и проверяйте версии.'}],
  ...
  ['ru/besplatnye-detektivnye-dela/index.html',{title:'10 бесплатных детективных дел онлайн',meta:'10 бесплатных детективных дел онлайн без регистрации. Изучайте материалы, находите противоречия и сразу проверяйте решение.'}],
