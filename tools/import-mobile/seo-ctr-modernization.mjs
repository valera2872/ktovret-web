...
function patchHome(siteRoot){
  ...
  if(!html.includes(HOME_TITLE)||!html.includes(HOME_DESCRIPTION)||!html.includes('>Играть бесплатно</a>')||!html.includes('>Для двоих</a>')||!html.includes('>Все дела</a>')||!html.includes('>Как играть</a>')) throw new Error('CTR SEO homepage patch failed');
