...
function normalizeOfferCopy(html){
  ...
  out=out.replaceAll('15 дел доступны без покупки','10 дел доступны без покупки');
  ...
  out=out.replaceAll('<p class="ref-kicker">Первый том</p><h1>100 детективных дел</h1><p>Полный архив коротких расследований Mystery Logic.<br>10 дел доступны бесплатно, ещё 85 открываются одной покупкой.</p>','<p class="ref-kicker">Два тома</p><h1>100 платных детективных дел</h1><p>Том I и Том II содержат по 50 расследований. Каждый том стоит 199 ₽, комплект из 100 платных дел — 299 ₽. 10 стартовых дел доступны бесплатно.</p>');
  out=out.replaceAll('<h1>Первый том «Кто врёт?» — 100 детективных задач</h1><p>Внутри несколько тематических архивов. 10 дел доступны без покупки.','<h1>Тома «Кто врёт?» — 100 платных детективных задач</h1><p>10 стартовых дел доступны бесплатно. Ещё 100 расследований разделены на Том I и Том II по 50.');
  out=out.replaceAll('Ещё 85 дел — одной покупкой','Ещё 100 платных дел — в двух томах');
  out=out.replaceAll('ещё 85 дел','ещё 100 платных дел в двух томах');
  out=out.replaceAll('Ещё 85 дел','Ещё 100 платных дел в двух томах');
  out=out.replaceAll('+ 85 дел в одном томе','+ 100 платных дел в двух томах');
