...
expect(art.length===30034, 'approved banner payload decodes to exact expected byte size');
...
expect(digest==='0c7a41164efdbd79f2515bd0922e6d2514b883bb9ba62e3289504190b61bd9d3', 'approved banner payload keeps exact approved artwork digest');
