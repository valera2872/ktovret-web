...
const index={schemaVersion:5,sourceCommit,mode,totalCases:lib.totalCases,freeCount:lib.freeCount,premiumCount:lib.premiumCount,volume1Count:lib.volume1Count,volume2Count:lib.volume2Count,seoNativeCaseCount,indexableCollectionCount,cases:lib.meta,freeCases:lib.freeMeta,collections:lib.collections};
...
if(fs.existsSync(product)){
  ...
  html=html.replace('</body>','<script src="../assets/generated/cases-index.js?v=2.0.0"></script><script src="../assets/dossier-model.js?v=1.1.0"></script><script src="../assets/dossier-progress.js?v=1.1.0"></script><script src="../assets/dossier-achievements.js?v=1.1.0"></script></body>');
...
const urls=[...new Set([base,`${base}kto-vret/`,`${base}dela/`,`${base}tom-1/`,...seoSlugs.map(slug=>`${base}${slug}/`),...collectionUrls,...seoExpansion.hubSlugs.map(slug=>`${base}${slug}/`),...seoExpansion.caseRoutes.map(route=>`${base}${route}`),...logicUrls])];
...
const report={sourceCommit,mode,packages:lib.assets.length,sourceEntries:lib.sourceEntries,deprecatedIds:lib.deprecatedCount,supplementalCases:lib.supplementalCount,totalCases:lib.totalCases,freeCases:lib.freeCount,premiumCases:lib.premiumCount,volume1Cases:lib.volume1Count,volume2Cases:lib.volume2Count,seoNativeCases:seoNativeCaseCount,indexableCollections:indexableCollectionCount,collectionPages:collectionPages.length,playablePages:editorial?lib.totalCases:lib.freeCount,lockedPages:editorial?0:lib.premiumCount,paidGatewayPages,indexableUrls:urls.length,seoLandingPages:seoSlugs.length,wordstatHubPages:seoExpansion.newHubPages,seoCasePages:seoExpansion.caseRoutes.length,premiumSeoTeaserPages:seoExpansion.premiumTeaserPages,wordstatUpdatedFreeCasePages:seoExpansion.updatedFreeCasePages,wordstatUpdatedHubPages:seoExpansion.updatedHubPages,finalPolishCaseTitles:finalPolish.caseTitles,finalPolishHubTitles:finalPolish.hubTitles,finalPolishRussianPages:finalPolish.russianPages,finalPolishVolumeChallenge:finalPolish.volumeChallenge,finalSeoCasePages:finalSeo.casePages,finalSeoHubPages:finalSeo.hubPages,finalSeoMaxCaseTitle:finalSeo.maxCaseTitle,finalSeoMaxCaseDescription:finalSeo.maxCaseDescription,finalSeoMaxHubTitle:finalSeo.maxHubTitle,finalSeoMaxHubDescription:finalSeo.maxHubDescription,twoPlayerRoomPage:twoPlayerRoom.page,twoPlayerRoomFreeCases:twoPlayerRoom.freeCases,twoPlayerSpecialCase:twoPlayer2317.route,twoPlayerPremiumCase:twoPlayer407.route,twoPlayerPremiumMaterials:twoPlayer407.materials,soloHubPage:'detektivnye-igry-dlya-odnogo',soloCaseRoute:'detektivnye-igry-dlya-odnogo/407',soloMaterials:twoPlayer407.materials,archiveVisualPages:archiveVisual.pages,archiveVisualVersion:archiveVisual.version,storefrontContractPages:storefrontContracts.pages,storefrontReferencePages:storefrontReference.pages,storefrontReferenceVersion:storefrontReference.version,storefrontReferenceV41Pages:storefrontReferenceV41.pages,storefrontReferenceV41Version:storefrontReferenceV41.version,storefrontV4WhoPages:storefrontV4Who.pages,storefrontV4WhoVersion:storefrontV4Who.version,storefrontV4MaterialPages:storefrontV4Material.pages,storefrontV4MaterialVersion:storefrontV4Material.version,caseV4Pages:caseV4.pages,caseV4Version:caseV4.version,coopV4Pages:coopV4.pages,coopV4Version:coopV4.version,storefrontFunctionalUxPages:storefrontFunctionalUx.pages,storefrontFunctionalUxVersion:storefrontFunctionalUx.version,storefrontFunctionalUxFreeCases:storefrontFunctionalUx.freeCasesVisible,storefrontVolumeSalesPages:storefrontVolumeSales.pages,storefrontVolumeSalesVersion:storefrontVolumeSales.version,logicHubRoute:logicExpertSeo.expertHub,logicHubPuzzles:logicExpertSeo.puzzles,logicHubPages:logicExpertSeo.routes.length,logicHubVersion:logicExpertSeo.version,logicHubHomePatched:logicExpertSeo.homePatched,logicLegacyGeneratorVersion:logicHub.version,logicExpertMainHub:logicExpertSeo.mainHub,logicExpertAdultHub:logicExpertSeo.adultHub,logicAudiencePages:logicAudience.routes.length,logicAudiencePuzzles:logicAudience.puzzles,logicAudienceCollections:logicAudience.collections,logicAudienceKids:logicAudience.kids,logicAudienceBrain:logicAudience.brain,logicAudienceDetective:logicAudience.detective,logicAudienceMath:logicAudience.math,logicAudienceMatches:logicAudience.matches,logicAudienceVersion:logicAudience.version,logicAudienceEditorialReady:puzzleEditorial.ready,logicAudienceEditorialReason:puzzleEditorial.reason,logicAudienceEditorialApproved:puzzleEditorial.approved,logicAudienceEditorialExactApproved:puzzleEditorial.exactApproved,logicAudienceEditorialTotal:puzzleEditorial.total,logicAudienceEditorialMismatched:puzzleEditorial.mismatched,logicAudienceEditorialMissing:puzzleEditorial.missing,logicAudienceLaunchCompat,logicSitewidePages:logicSitewide.pages,logicSitewideNavPatched:logicSitewide.navPatched,logicSitewideLegacyLinksRewritten:logicSitewide.legacyLinksRewritten,logicSitewideVersion:logicSitewide.version,funnelAnalyticsPages:funnelAnalytics.pages,funnelAnalyticsVersion:funnelAnalytics.version,playerFeedbackPages:playerFeedback.injected,playerFeedbackVersion:playerFeedback.version,witnessEnhancedPages,seoNativePostprocessedPages,legalFooterPages};
