...
import {applyCaseEntryReference} from './import-mobile/case-entry-reference-postprocess.mjs';
...
const caseEntryReference=applyCaseEntryReference(siteRoot);
