...
import {applyStorefrontV4Sharp} from './import-mobile/storefront-v4-sharp-postprocess.mjs';
...
const storefrontV4Sharp=applyStorefrontV4Sharp(siteRoot,lib.cases);
