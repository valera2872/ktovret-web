...
for (const marker of ['case-407-evidence-v2.css', 'case-407-evidence-v3.css', 'case-407-evidence-v2.js', 'case-407-evidence-finalize.js', 'case-407-detective-visual-v4.js', "const VERSION = '1.6.0'"]) expect(postprocess.includes(marker), `generated case page does not load ${marker}`);
...
expect(!js.includes('fetch(') && !finalizer.includes('fetch(') && !detectiveVisual.includes('fetch('), 'evidence layer must not depend on external runtime fetches');
