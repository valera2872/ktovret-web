(()=>{"use strict";
const DEFAULT_CONFIG={enabled:false,provider:"heygen",sessionEndpoint:""};
...
class HeyGenLiveAvatarProvider extends AvatarProvider{
  async connect({video,suspectId}={}){
    ...
    const response=await fetch(endpoint,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({provider:"liveavatar",suspect_id:this.suspectId,mode:"lite"})});
