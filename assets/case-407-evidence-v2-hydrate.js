(() => {
  ...
  const registryArtifact = () => `<div class="case407-artifact case407-registry"><div class="case407-artifact-head"><span>РЕЕСТР ОБОРУДОВАНИЯ</span><b>ARCHIVE 2019</b></div><div class="case407-registry-title">HOTEL MEYER · FLOOR 4 / DOOR HARDWARE</div><div class="case407-registry-row head"><span>PHY NODE</span><span>LOCK ID</span><span>PLAQUE LOT</span><span>GUEST LABEL</span></div><div class="case407-registry-row"><b>407</b><code>L-407</code><code class="blurred">H-???</code><span>редактируемое поле</span></div><div class="case407-registry-row focus"><b>409</b><code>L-409</code><code>H-409</code><span>редактируемое поле</span></div><div class="case407-registry-note">Физические ID контроллеров не менялись после ремонта. Гостевая надпись хранится отдельно.</div></div>`;
  ...
  const normalizeCurrentMaterial = (card, artifact, title) => {
    ...
    if (key.includes('контроллеры и таблички') && !artifact.classList.contains('case407-registry')) {
      artifact.outerHTML = registryArtifact();
