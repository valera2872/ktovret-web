(function (root) {
  ...
  const roman = {
    ...
    topics: [
      ...
      {
        id: 'access',
        keywords: ['t-17', 't17', 'пропуск', 'стойк', 'проход'],
      ...
      {
        id: 'presence',
        keywords: ['офис', 'вернул', 'возвращал', 'ночью', '18:30', '20:47', 'порт', 'ресторан', 'алиби', 'ужин', 'rk-pixel', 'соврал'],
      ...
      {
        id: 'motive',
        keywords: ['мотив', 'зачем', 'почему', 'продал', 'сделк', 'инвестор', 'деньг', 'транш'],
      ...
      {
        id: 'pavel',
        keywords: ['павел', 'orbit', 'nightsafe', 'депозит', 'исчез'],
