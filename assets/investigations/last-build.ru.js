  ...
  root.MysteryLogicInvestigationCase = {
    ...
    characters: [
      {
        ...
        relationship: 'Сотрудница студии «Кадр 17»',
        responsibility: 'Организует работу офиса, выдаёт гостевые пропуска и готовит встречи.',
        introduction:
          'Я отвечаю за работу офиса: пропуска, документы, встречи и подготовку презентаций. Вечером закрывала помещение последней.',
      ...
      },
      {
        ...
        relationship: 'Сотрудник студии · отвечает за техническую часть игры',
        responsibility: 'Собирает финальную версию игры и готовит компьютер в переговорной к презентации.',
        introduction:
          'Я отвечаю за техническую часть проекта и финальную версию игры. DEMO-04 — общий компьютер в переговорной, на котором утром должны были показать игру инвестору.',
        portrait: '../../../assets/investigations/last-build-art/timur-vlasov.webp',
        initialStatement:
          'Я ушёл в 19:26. Готовую версию игры оставил на общем компьютере DEMO-04, свою сессию закрыл. Других копий не делал.',
        statementStates: [
          {
      ...
      },
      {
        ...
        relationship: 'Не сотрудник студии · представляет инвестора',
        responsibility: 'Проверяет ход проекта перед решением о дальнейшем финансировании.',
        introduction:
          'Я консультирую компанию, которая вкладывает деньги в игру. В студию приезжал проверить готовность проекта перед презентацией.',
        portrait: '../../../assets/investigations/last-build-art/roman-karsky.webp',
        initialStatement:
          'После 18:30 в офис я не возвращался. Ужинал в «Порту». Гостевой пропуск T-17 оставил на стойке ещё днём. У меня была только неполная версия игры для ознакомления.',
        statementStates: [
          {
      ...
      },
      {
        ...
        relationship: 'Основатель студии «Кадр 17»',
        responsibility: 'Руководит командой и отвечает за переговоры с инвестором.',
        introduction: 'Недоступен для опроса.',
    ...
    materials: [
      ...
      },
      {
        ...
        availableFromStart: true,
        body:
          'Общий компьютер для презентаций DEMO-04 включён. Рабочий телефон Павла стоит на зарядке. На столе — пустой футляр официальной флешки ORBIT-2. Папка RELEASE с финальной версией игры на компьютере отсутствует. Следов взлома дверей нет.',
        grantsFacts: ['orbit_missing', 'pavel_phone_left', 'demo04_on'],
      },
      {
        id: 'initial-statements',
        title: 'Первые опросы участников',
        type: 'Опросы',
        availableFromStart: true,
        body:
          'Алина Соколова, операционный менеджер: отвечает за офис, документы и гостевые пропуска. Утверждает, что все временные пропуска были возвращены.\n\nТимур Власов, технический руководитель: отвечает за финальную версию игры. Объясняет, что DEMO-04 — общий компьютер для презентаций. Утверждает, что ушёл в 19:26, свою сессию закрыл и других копий не делал.\n\nРоман Карский, консультант инвестора: не работает в студии, а проверяет проект перед решением о финансировании. Утверждает, что после 18:30 не возвращался, гостевой пропуск T-17 оставил на стойке и имел только неполную версию игры для ознакомления.',
        grantsFacts: [
      ...
      {
        id: 'delete-audit',
        title: 'Журнал действий на компьютере DEMO-04',
        type: 'Системный журнал',
        availableFromStart: true,
        body:
          'DEMO-04 — общий компьютер в переговорной, подготовленный для презентации игры.\n\n20:59:07   Папка удалена\nКомпьютер   DEMO-04\nПользователь t.vlasov\nПуть        /RELEASE/final_build\n\nЗапись фиксирует имя активной локальной сессии, а не личность человека за компьютером.',
      ...
      },
      {
        ...
        availableFromStart: true,
        body:
          'На утро 18 октября назначена закрытая презентация готовой версии игры. Павел Нестеров руководит студией. Тимур Власов отвечает за техническую часть и финальную версию. Алина Соколова отвечает за работу офиса, документы и пропуска. Роман Карский не является сотрудником студии: он представляет инвестора и проверяет готовность проекта.',
