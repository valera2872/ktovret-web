(function (root) {
  ...
  set('initial-statements', {
    kind: 'statements', items: [
      { initials: 'АС', name: 'Алина Соколова', role: 'operations', text: 'Все временные пропуска были возвращены.' },
      { initials: 'ТВ', name: 'Тимур Власов', role: 'technical lead', text: 'Ушёл в 19:26, сессию DEMO-04 закрыл, других копий нет.' },
      { initials: 'РК', name: 'Роман Карский', role: 'консультант инвестора', text: 'После 18:30 не возвращался, T-17 оставил на стойке, финальной сборки не имел.' },
    ],
  });
  set('delete-audit', {
    kind: 'terminal', title: 'DEMO-04 · endpoint audit',
    lines: ['20:59:07  Directory removed', 'Host       DEMO-04', 'User       t.vlasov', 'Path       /RELEASE/final_build'],
  ...
  set('studio-brief', {
    kind: 'web', url: 'kadr17.studio / team', kicker: 'GAME STUDIO · CLOSED PRESENTATION', heading: 'Кадр 17',
    lead: 'Небольшая игровая студия готовит закрытую презентацию финальной сборки утром 18 октября.',
    cards: [
      { title: 'Павел Нестеров', text: 'руководитель студии' }, { title: 'Тимур Власов', text: 'технический лидер' },
      { title: 'Алина Соколова', text: 'operations' }, { title: 'Роман Карский', text: 'консультант инвестора' },
    ],
  });
  set('access-log', {
