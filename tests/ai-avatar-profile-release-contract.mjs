...
assert.match(session,/const isSandboxSession=Boolean\(!previewOverride&&!publishedAvatarId&&sandboxFallbackAllowed&&allowedAvatarId===LIVEAVATAR_SANDBOX_AVATAR_ID\)/,'Wayne alone must use sandbox mode');
